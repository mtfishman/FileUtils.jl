---
name: FileUtils.jl bug report
about: Create a bug report to help us improve FileUtils.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("FileUtils")`:
```julia
julia> using Pkg; Pkg.status("FileUtils")
[YOUR OUTPUT HERE]
```
